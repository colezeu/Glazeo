...
const PRODUCTS = [
  ...
  { id: "cadita-dus",      name: "Cădițe Duș Compozit",     tagline: "Alb · Gri · Negru · Crem",                  price: "de la 280 €/m²", path: "/configurator/cadita-dus",       desc: "Cădițe duș din compozit, pantă integrată + sifon inclus. Dimensiuni maxime 1.1m × 2.0m, înălțime 3cm.", active: true },
