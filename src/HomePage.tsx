...
const PRODUCTS = [
  ...
  { id: "inchidere-terasa", name: "Închidere Multitrack",     tagline: "Șine multiple, 2-8 canate culisante",          price: "de la 145 €/ml", path: "/configurator/inchidere-terasa", desc: "Sistem clasic multitrack cu șine și canate culisante. Profile laterale, încuietori, mânere și vopsire RAL.", active: true },
  { id: "frameless",        name: "Frameless Full-Glass",     tagline: "Panouri sticlă fără rame vizibile",           price: "de la 350 €/ml", path: "/configurator/frameless",        desc: "Design minimalist: panouri full-glass cu prinderi punctuale din inox. Fără rame, transparență maximă.", active: true },
  { id: "ghilotina",        name: "Ghilotină Verticală",      tagline: "Ridicare verticală, 1+1 sau 1+2 mobil",       price: "de la 480 €/ml", path: "/configurator/ghilotina",        desc: "Sistem cu contragreutate pentru ridicare verticală. Configurație automată 1+1 sau 1+2 după înălțime.", active: true },
