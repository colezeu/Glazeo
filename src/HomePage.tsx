...
const PRODUCTS = [
  ...
  { id: "vitrovibe",       name: "VitroVibe®",             tagline: "Textile reale în sticlă securizată",          price: "de la 250 €/m²", path: "/configurator/vitrovibe",       desc: "Încapsulăm textile și materiale reale direct între straturile de sticlă securizată. Nu folii printate, nu sablare — textură tridimensională autentică, dezvoltată în atelierul propriu din Arad. Fiecare panou este unic și personalizabil.", active: true },
];
