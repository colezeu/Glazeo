...
export default function OglinziConfiguratorPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0f1117", color: "#f0ede8" }}>
      <QuoteModal isOpen={showModal} onClose={() => setShowModal(false)} quote={quote} productName="Oglindă" config={{ dims, mirrorType, shape, thickness, edge, inclLed, inclAntiAburire }} />
      ...
      {showSaveModal && (
        <SaveProjectModal
          productType="oglinda"
          config={{ dims, mirrorType, shape, thickness, edge, inclLed, inclAntiAburire }}
